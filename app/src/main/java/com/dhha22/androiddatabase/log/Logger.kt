package com.dhha22.androiddatabase.log

import android.util.Log
import com.dhha22.androiddatabase.BuildConfig
import java.util.*
...
object Logger {
    ...
    private val TAG = "AndroidDatabase"
    private val needLong = true
    val LOG_SEPARATE_LENGTH = 3000

    private fun longInfo(str: String): ArrayList<String> {
        var str = str
